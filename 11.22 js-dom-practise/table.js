...
let asending = document.querySelector(".asending");
let desending = document.querySelector(".desending");
let sortName = document.querySelector(".sortName");

asending.addEventListener("click", function () {
  let asen = data.sort((a, b) => {
    return a.id - b.id;
  });
  table(asen);
});

desending.addEventListener("click", function () {
  let asen = data.sort((a, b) => {
    return b.id - a.id;
  });
  table(asen);
